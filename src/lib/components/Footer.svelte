  ...
  <div class="max-w-[1400px] mx-auto">
    <div class="grid grid-cols-2 md:grid-cols-5 gap-12 mb-24">
      ...
      <div class="flex flex-col gap-4">
        ...
        <a href="/" class="hover:text-gray-300 transition-colors">Features</a>
        <a href="/" class="hover:text-gray-300 transition-colors">Pricing</a>
        <a href="/" class="hover:text-gray-300 transition-colors">Integrations</a>
      </div>

      <!-- Col 2 -->
      <div class="flex flex-col gap-4">
        <h4 class="text-gray-500 mb-2">Solutions —</h4>
        <a href="/" class="hover:text-gray-300 transition-colors">Creative Agencies</a>
        <a href="/" class="hover:text-gray-300 transition-colors">Production Studios</a>
        <a href="/" class="hover:text-gray-300 transition-colors">Game Developers</a>
      </div>

      <!-- Col 3 -->
      <div class="flex flex-col gap-4">
        <h4 class="text-gray-500 mb-2">Resources —</h4>
        <a href="/" class="hover:text-gray-300 transition-colors">Case Studies</a>
        <a href="/" class="hover:text-gray-300 transition-colors">Documentation</a>
        <a href="/" class="hover:text-gray-300 transition-colors">Support</a>
        <a href="/" class="hover:text-gray-300 transition-colors">Community</a>
      </div>
      ...
      <div class="flex flex-col gap-4 items-start md:items-end">
        <a href="mailto:hello@bravestudio.com" class="font-medium border-b border-white pb-0.5 hover:opacity-80 transition-opacity">hello@bravestudio.com</a>
        <a href="/" class="font-medium border-b border-white pb-0.5 hover:opacity-80 transition-opacity">@bravestudio</a>
      </div>
    </div>

    <!-- Bottom Legal Text -->
    <div class="border-t border-gray-900 pt-12 text-[11px] text-gray-600 leading-relaxed">
      <p class="mb-6">
        Brave Studio helps creative teams turn ideas into finished video—faster, together. Our AI-powered platform streamlines creative workflows from concept to final export.
      </p>
      <p>
        All content, designs, and materials created using Brave Studio remain the intellectual property of the user. We employ industry-standard security measures to protect your creative assets and client data. For enterprise security requirements, please contact our team.
      </p>
    </div>
    ...
    <div class="mt-12 flex items-center gap-4 text-xs text-gray-500">
      <div class="flex items-center gap-2">
        ...
        <span class="font-bold text-white tracking-tight">Brave Studio</span>
      </div>
